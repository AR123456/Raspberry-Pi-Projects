...
# 7)put _pwm_demo.gif in same loc as py
# # 8) The code runs demo of different duty cycle vs requ when mouse moved 
...
# output (Pulse width modulation) pwm via GPIO12 (pin 32) and GPIO13 (pin 33)
